...
//import net.sf.jasperreports.engine.*; esto es para compilar los jxml
//import net.sf.jasperreports.view.JasperViewer;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jdpescritorio.setBackground(new java.awt.Color(0, 0, 204));
        ...
        jMenuItem15.setText("Ingreso Stock");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jdpescritorio, javax.swing.GroupLayout.DEFAULT_SIZE, 800, Short.MAX_VALUE)
        );
...
// TODO add your handling code here:
        ...
        try {
            ...
            String ruta="reportesClientes.jasper";
            JasperPrint informe=JasperFillManager.fillReport(ruta, null,cc.conexion());
            JasperViewer ventana=new JasperViewer(informe,false);
            ventana.setTitle("Informe de Clientes");
...
// TODO add your handling code here:
           try {
            conectar cc= new conectar();
            String ruta="reportesProductos.jasper";
            JasperPrint informe=JasperFillManager.fillReport(ruta, null,cc.conexion());
            JasperViewer ventana=new JasperViewer(informe,false);
            ventana.setTitle("Informe de Productos");
            ventana.setVisible(true);
...
// TODO add your handling code here:
    try {
            conectar cc= new conectar();
            String ruta="reportesFacturas.jasper";
            JasperPrint informe=JasperFillManager.fillReport(ruta, null,cc.conexion());
            JasperViewer ventana=new JasperViewer(informe,false);
            ventana.setTitle("Informe de Facturas");
            ventana.setVisible(true);
...
// TODO add your handling code here:
      try {
            conectar cc= new conectar();
            String ruta="reportesBoletas.jasper";
            JasperPrint informe=JasperFillManager.fillReport(ruta, null,cc.conexion());
            JasperViewer ventana=new JasperViewer(informe,false);
            ventana.setTitle("Informe de Boletas");
            ventana.setVisible(true);
    ...
    private void jMenuItem15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem15ActionPerformed
        // TODO add your handling code here:
        IngresoStock Stock=new IngresoStock();
        jdpescritorio.add(Stock);
        Stock.show();
