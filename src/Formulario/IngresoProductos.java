...
public class IngresoProductos extends javax.swing.JInternalFrame {
    /////////
    Clases.LlenarCombos combo;
    java.util.ArrayList arrayUndMed; javax.swing.DefaultComboBoxModel modeloUndMed;
    /////////
    ...
    void cargar(String valor) {
        ////llenamos el combo con las unidades de medida
        combo=new Clases.LlenarCombos();
        arrayUndMed=new java.util.ArrayList();
        modeloUndMed=new javax.swing.DefaultComboBoxModel();
        String sql="Select * from base_undmed order by desc_undmed ASC;";
        combo.llenarCombos(arrayUndMed, modeloUndMed, sql, "cod_undmed", "desc_undmed", cboUndMed);
        ////////////////////
        try{
            String [] titulos={"Codigo","Unidad","Descripcion","Precio","Stock"};
            String [] registros= new String[5];
            model=new DefaultTableModel(null,titulos);
            
            String cons="select "
                    + " P.cod_pro, BUM.desc_undmed, P.descripcion, P.precio, P.stock "
                    + " from producto P "
                    + " join base_undmed BUM on P.cod_undmed=BUM.cod_undmed "
                    + " WHERE CONCAT (descripcion,'',precio) LIKE '%"+valor+"%'";
            ...
            tbproductos.getColumnModel().getColumn(1).setPreferredWidth(20);
        ...
        try{
            ...
            String codi="",undmed="",desc="",prec="",stock="";
            ...
            txtcod.setText(codi);
            cboUndMed.setSelectedItem(undmed);
            txtdes.setText(desc);
            txtpre.setText(prec);
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cboUndMed, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel6)
                    .addComponent(cboUndMed, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(16, 16, 16)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
        ...
        txtbuscar.setToolTipText("Escriba la descripción del producto");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.TRAILING, 0, 517, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
...
// TODO add your handling code here:
    String cod,undmed,des,pre,stock;
            String sql="";
            cod=txtcod.getText();
            undmed=arrayUndMed.get(cboUndMed.getSelectedIndex())+"";
            des=txtdes.getText();
            pre=txtpre.getText();
            stock=txtstock.getText();
            sql="INSERT INTO producto (cod_pro,cod_undmed, descripcion,precio,Stock) VALUES (?,?,?,?,?)";
        try {
            PreparedStatement pst  = cn.prepareStatement(sql);
            pst.setString(1, cod);
            pst.setString(2,undmed);
            pst.setString(3, des);
            pst.setString(4, pre);
