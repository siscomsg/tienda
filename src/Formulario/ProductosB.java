...
DefaultTableModel tabla;
    ...
    String mostrar="SELECT * FROM producto WHERE CONCAT (cod_pro,'',descripcion) LIKE '%"+dato+"%' and stock >0"; 
    Statement st;
        try {
...
// TODO add your handling code here:
    ...
    else
    {
        ...
        int j=0;
         ...
         String prec=JOptionPane.showInputDialog("Ingrese precio de Venta");
        if((cant.equals("")) || (cant.equals("0")) || ((prec.equals("") || prec.equals("0"))))
        {
